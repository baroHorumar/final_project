                        ...
                        <div class="blog grid-blog flex-fill">
                            <div class="blog-image">
                                <a href="blog-details.php?post_id=<?= $post['id'] ?>">
                                    <img class="img-fluid" src="<?php echo $post['image'] ?? ''; ?>" alt="Post Image" style="max-width: 290px; max-height: 150px; min-width: 290px; min-height: 150px;">
                                </a>
                                ...
                                <ul class="entry-meta meta-item">
                                    <li>
                                        <div class="post-author">
                                            <a href="profile.php?alumni_id=<?= $post['alumni_id'] ?>">
                                                <?php
                            ...
                            <div class="row ">
                                <div class="edit-options">
                                    ...
                                    <form method="post" action="delete.php" style="margin-right: 20px; background-color:#ffe5e5; border-radius: 5px;">
                                        <input type="hidden" name="post_id" value="<?php echo $post['id']; ?>">
                                        <button type="submit" style="background-color:#ffe5e5; border-radius: 5px;" class="text-danger border-0 rounded" onclick="return confirm('Are you sure you want to delete this post?')"><i class="px-2 py-2">Delete</i></button>
                                    </form>
