            ...
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="blog-view">
                    <div class="blog-single-post">
                        ...
                        if (isset($_GET['post_id'])) {
                            $post_id = $_GET['post_id'];
                            // Retrieve the reader_id from the session
                            $reader_id = $_SESSION['id'];
                            // Insert the post_id and reader_id into the reads table
                            $insert_query = "INSERT INTO reader (post_id, reader_id) VALUES (?, ?)";
                            $stmt = $conn->prepare($insert_query);
                            $stmt->bind_param("ii", $post_id, $reader_id);
                        }
                                    ...
                                    ?>
                                            <li>
                                                ...
                                                <div class="comment">
                                                    ...
                                                    <div class="comment-block">
                                                        <div class="comment-by">
                                                            <h5 class="blog-author-name"><?= htmlspecialchars($comment['username']) ?><span class="blog-date"> <i class="feather-clock me-1"></i>
                                                ...
                                                <ul class="comments-list reply">
                                                    ...
                                                    $stmt_reply = $conn->prepare($reply_comments_query);
